...
# Pages
## Home page - Sydney
- [ ] Overview with a few photos, maybe a highlight of what makes us unique.
## Menu page
- [ ] Our bagel and sandwich options, ideally with images for each bagel or category.
- [ ] Embedded Google map for directions
- [ ] Spot for announcements or seasonal flavours
## Preorder form - Nico
