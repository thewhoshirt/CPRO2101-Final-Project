    ...
    return(
        ...
        <BodyContainer>
            <Heading>
                ...
                <HeadingText>
                    <h1>About Us</h1>
                    <h3 className='accentHeader'>Our Story</h3>
                </HeadingText>
            </Heading>
            ...
            <IntroText>
                ...
                <p>We're the owners + operators of Booyah Bagels - but more importantly, <br/>
                        we're a couple of Red Deer locals looking to spread a little <b style={{color:'#0057E2'}} > L O V E </b> in our community. </p>
                ...
                <PinkHeading className='accentHeader'style={{color:'#0057E2'}}>Curious what all the buzz is about?  POP IN FOR A BITE!</PinkHeading>
            </IntroText>
            
            <PurposeDiv>
                <Image src="/Booyah Assets/Brand images/Z and K on case.jpg" alt="Z and K on case"/>
                <AboutPurpose>
                    <PinkHeading className='accentHeader' style={{color:'#0057E2'}}>Our Purpose</PinkHeading>
                    <BlueHeading style={{color:'#FF5FBE'}}>We're here to uplift our community by spreading good vibes and better bites, made with only the best ingredients.</BlueHeading>
