...
const About = () => {
    return(
        <>
            <div>
                <div class="heading">
                    <img src="../../public/Booyah Assets/GIFS/Rotating Booyah Blue.gif" alt="Booyah Logo" class="booyah-logo"/>
                ...
                <div className="intro-text">
                    ...
                    <h2 class="pink-heading">Curious what all the buzz is about?  POP IN FOR A BITE!</h2>
                </div>
                <div class="purpose-div">
                    <img src="../../public/Booyah Assets/Brand images/Z and K on case.jpg" alt="Z and K on case" class="image"/>
                    <div class="about-purpose">
                        <h2>Our Purpose</h2>
                        <h3>We're here to uplift our community by spreading good vibes and better bites, made with only the best ingredients.</h3>
                ...
                <div class="pillars-div">
                    <div class="about-pillars">
                        <h2>Our Pillars</h2>
                        <h3>STAY TRUE, BE INTENTIONAL, AND LET THE GOOD VIBES ROLL.</h3>
                        <p>TRUE // Refreshingly real philosophy</p>
                        ...
                        <p>VIBE // Ridiculously delicious experience</p>
                        ...
                        <p>INTENTION // Radically for the people connection</p>
                    ...
                    <img src="../../public/Booyah Assets/Brand images/moving bagels 2.jpg" alt="moving bagels" class="image"/>
                </div>
            </div>
        </>
    );
